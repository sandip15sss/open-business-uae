                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          className={`w-full bg-transparent border rounded-none py-3 px-4 font-sans text-sm text-charcoal placeholder:text-slate-grey/50 focus:outline-none transition-colors ${
                            errors.name ? "border-red-500 focus:border-red-500" : "border-[#C5A880]/30 focus:border-champagne-gold"
                          }`}
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full bg-transparent border rounded-none py-3 px-4 font-sans text-sm text-charcoal placeholder:text-slate-grey/50 focus:outline-none transition-colors ${
                            errors.email ? "border-red-500 focus:border-red-500" : "border-[#C5A880]/30 focus:border-champagne-gold"
                          }`}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full bg-transparent border rounded-none py-3 px-4 font-sans text-sm text-charcoal placeholder:text-slate-grey/50 focus:outline-none transition-colors ${
                            errors.phone ? "border-red-500 focus:border-red-500" : "border-[#C5A880]/30 focus:border-champagne-gold"
                          }`}
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full bg-transparent border rounded-none py-3 px-4 font-sans text-sm text-charcoal focus:outline-none transition-colors appearance-none ${
                          errors.service ? "border-red-500 focus:border-red-500" : "border-[#C5A880]/30 focus:border-champagne-gold"
                        }`}
                        style={{
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        className={`w-full bg-transparent border rounded-none py-3 px-4 font-sans text-sm text-charcoal placeholder:text-slate-grey/50 focus:outline-none transition-colors ${
                          errors.message ? "border-red-500 focus:border-red-500" : "border-[#C5A880]/30 focus:border-champagne-gold"
                        }`}
                    ...
                    <button
                      ...
                      className="w-full bg-charcoal hover:bg-champagne-gold disabled:bg-charcoal/50 text-alabaster hover:text-charcoal font-sans font-bold text-xs tracking-widest uppercase py-4.5 transition-all duration-500 flex items-center justify-center gap-2 group"
                    >
                      {isSubmitting ? (
                        <>
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <ContactCard
                  ...
                  value="hello@openbusiness.ae"
                  subtext="Average client response speed: 2 hours"
                  href="mailto:hello@openbusiness.ae"
                  icon={Mail}
                  delay={0.15}
                />
